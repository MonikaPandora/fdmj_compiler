...
C7:
  ...
  store i64 0, ptr %r153, align 8
  %r154 = add i64 0, 0
  %s155 = call double @getfloat()
  %r156 = fptosi double %s155 to i64
  %r157 = add i64 %r156, 1
  %r158 = mul i64 %r157, 8
  %r159 = call ptr @malloc(i64 %r158)
  %r160 = ptrtoint ptr %r159 to i64
  %r161 = inttoptr i64 %r160 to ptr
  store i64 %r156, ptr %r161, align 8
  %r162 = add i64 %r160, 8
  %r163 = add i64 %r162, 0
  %r164 = sub i64 %r163, 8
  %r165 = inttoptr i64 %r164 to ptr
  %r166 = load i64, ptr %r165, align 8
  %r167 = call ptr @malloc(i64 16)
  %r168 = ptrtoint ptr %r167 to i64
  %r169 = inttoptr i64 %r168 to ptr
  store i64 2, ptr %r169, align 8
  %r170 = inttoptr i64 %r168 to ptr
  %r171 = ptrtoint ptr @"c1$m1" to i64
  store i64 %r171, ptr %r170, align 8
  %r172 = add i64 %r168, 0
  %r173 = call ptr @malloc(i64 16)
  %r174 = ptrtoint ptr %r173 to i64
  %r175 = inttoptr i64 %r174 to ptr
  store i64 2, ptr %r175, align 8
  %r176 = inttoptr i64 %r174 to ptr
  %r177 = ptrtoint ptr @"c2$m1" to i64
  store i64 %r177, ptr %r176, align 8
  %r178 = add i64 %r174, 0
  br label %L0
...
L1:                                               ; preds = %L0
  %r181 = inttoptr i64 %r163 to ptr
  call void @putarray(i64 %r166, ptr %r181)
  ret i64 %r166
...
L2:                                               ; preds = %L5
  ...
  %r195 = inttoptr i64 %r172 to ptr
  %r196 = load i64, ptr %r195, align 8
  %r197 = inttoptr i64 %r196 to ptr
  %r198 = call i64 %r197(i64 %r172, i64 %r179)
  %r199 = inttoptr i64 %r194 to ptr
  store i64 %r198, ptr %r199, align 8
  br label %L4
}

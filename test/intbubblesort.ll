...
C11:
  ...
  store i64 6, ptr %r145, align 8
  %r146 = add i64 %r142, 8
  %r147 = inttoptr i64 %r146 to ptr
  store i64 3, ptr %r147, align 8
...
L6:                                               ; preds = %L2
  ...
  %r230 = load i64, ptr %r229, align 8
  %r231 = icmp sgt i64 %r225, %r230
...
L4:                                               ; preds = %L6
  ...
  %r236 = load i64, ptr %r235, align 8
  %r237 = mul i64 %r214, 8
  ...
  store i64 %r244, ptr %r239, align 8
  %r245 = add i64 %r214, 1
  %r246 = mul i64 %r245, 8
  %r247 = add i64 %r100, %r246
  %r248 = inttoptr i64 %r247 to ptr
  store i64 %r236, ptr %r248, align 8
  br label %L5
}

...
define i64 @main() {
C1:
  %s110 = fadd double 1.100000e+00, 0.000000e+00
  %r111 = call ptr @malloc(i64 24)
  %r112 = ptrtoint ptr %r111 to i64
  %r113 = add i64 %r112, 8
  %r114 = sub i64 %r113, 8
  %r115 = inttoptr i64 %r114 to ptr
  store i64 2, ptr %r115, align 8
  %r116 = inttoptr i64 %r113 to ptr
  %r117 = fptosi double %s110 to i64
  store i64 %r117, ptr %r116, align 8
  %r118 = add i64 %r113, 8
  %r119 = inttoptr i64 %r118 to ptr
  store i64 2, ptr %r119, align 8
  br label %C0

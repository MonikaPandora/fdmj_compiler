...
C10:
  ...
  store i64 9, ptr %r183, align 8
  %r184 = add i64 %r162, 80
  %r185 = inttoptr i64 %r184 to ptr
  store i64 6, ptr %r185, align 8
  %r186 = add i64 0, 0
  %r187 = call ptr @malloc(i64 56)
  %r188 = ptrtoint ptr %r187 to i64
  %r189 = inttoptr i64 %r188 to ptr
  %r190 = ptrtoint ptr @"s$pop" to i64
  store i64 %r190, ptr %r189, align 8
  %r191 = inttoptr i64 %r188 to ptr
  %r192 = ptrtoint ptr @"s$push" to i64
  store i64 %r192, ptr %r191, align 8
  %r193 = inttoptr i64 %r188 to ptr
  %r194 = ptrtoint ptr @"s$empty" to i64
  store i64 %r194, ptr %r193, align 8
  %r195 = inttoptr i64 %r188 to ptr
  %r196 = ptrtoint ptr @"s$clear" to i64
  store i64 %r196, ptr %r195, align 8
  %r197 = add i64 %r188, 0
...
C16:
  ...
  %r274 = load i64, ptr %r273, align 8
  %r275 = mul i64 %r274, 8
  %r276 = add i64 %r271, %r275
  %r277 = inttoptr i64 %r276 to ptr
  store i64 %r100, ptr %r277, align 8
  %r278 = add i64 %r99, 8
  ...
  %r283 = add i64 %r282, 1
  store i64 %r283, ptr %r279, align 8
  ret i64 1
}

define i64 @"s$empty"(i64 %r99) {
C19:
  %r290 = inttoptr i64 %r99 to ptr
...
C23:
  %r303 = inttoptr i64 %r99 to ptr
  store i64 0, ptr %r303, align 8
  %r304 = add i64 %r99, 8
  %r305 = inttoptr i64 %r304 to ptr
  store i64 0, ptr %r305, align 8
  %r306 = add i64 %r99, 16
  %r307 = call ptr @malloc(i64 808)
  %r308 = ptrtoint ptr %r307 to i64
  %r309 = inttoptr i64 %r308 to ptr
  store i64 100, ptr %r309, align 8
  %r310 = add i64 %r308, 8
  %r311 = inttoptr i64 %r306 to ptr
  store i64 %r310, ptr %r311, align 8
  ret i64 0
}

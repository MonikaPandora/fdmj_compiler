...
L2:                                               ; preds = %L1
  ...
  %r122 = call ptr @malloc(i64 24)
  %r123 = ptrtoint ptr %r122 to i64
  %r124 = inttoptr i64 %r123 to ptr
  store double 1.000000e+00, ptr %r124, align 8
  %r125 = add i64 %r123, 16
  %r126 = inttoptr i64 %r125 to ptr
  store double 1.000000e+00, ptr %r126, align 8
  %r127 = inttoptr i64 %r123 to ptr
  %r128 = ptrtoint ptr @"c1$m" to i64
  store i64 %r128, ptr %r127, align 8
  %r129 = add i64 %r123, 0
  %r130 = inttoptr i64 %r129 to ptr
  %r131 = load i64, ptr %r130, align 8
...
C7:
  %r142 = inttoptr i64 %r99 to ptr
  %s143 = load double, ptr %r142, align 8

...
C1:
  %r110 = call i64 @getch()
  call void @putch(i64 %r110)
  call void @putch(i64 10)
  call void @putint(i64 %r110)
  call void @putch(i64 10)
  %s111 = call double @getfloat()
  %r112 = fptosi double %s111 to i64
  call void @putint(i64 %r112)
  call void @putch(i64 10)
  %r113 = call ptr @malloc(i64 168)
  %r114 = ptrtoint ptr %r113 to i64
  %r115 = inttoptr i64 %r114 to ptr
  store i64 20, ptr %r115, align 8
  %r116 = add i64 %r114, 8
  %r117 = add i64 %r116, 0
  %r118 = inttoptr i64 %r117 to ptr
  %r119 = call i64 @getarray(ptr %r118)
  call void @putint(i64 %r119)
  call void @putch(i64 10)
  %r120 = inttoptr i64 %r117 to ptr
  call void @putarray(i64 %r119, ptr %r120)
  call void @putch(i64 10)
  ret i64 0
}

...
define i64 @main() {
C4:
  %r119 = call ptr @malloc(i64 16)
  %r120 = ptrtoint ptr %r119 to i64
  %r121 = add i64 %r120, 8
  %r122 = sub i64 %r121, 8
  %r123 = inttoptr i64 %r122 to ptr
  store i64 1, ptr %r123, align 8
  %r124 = inttoptr i64 %r121 to ptr
  store double 9.000000e+00, ptr %r124, align 8
  %r125 = add i64 %r121, 0
  %r126 = add i64 %r121, 0
  %r127 = inttoptr i64 %r126 to ptr
  %s128 = load double, ptr %r127, align 8
  %r129 = add i64 0, 0
...
L2:                                               ; preds = %L1, %L0
  ...
  %r134 = inttoptr i64 %r125 to ptr
  %s135 = sitofp i64 %r133 to double
  store double %s135, ptr %r134, align 8
  %r136 = sub i64 %r121, 8

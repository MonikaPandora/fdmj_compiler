...
C1:
  ...
  call void @putch(i64 10)
  %r171 = call ptr @malloc(i64 32)
  %r172 = ptrtoint ptr %r171 to i64
  %r173 = call ptr @malloc(i64 32)
  %r174 = ptrtoint ptr %r173 to i64
  %r175 = add i64 %r174, 8
  %r176 = sub i64 %r175, -8
  %r177 = inttoptr i64 %r176 to ptr
  store i64 3, ptr %r177, align 8
  %r178 = inttoptr i64 %r175 to ptr
  store double 1.100000e+00, ptr %r178, align 8
  %r179 = add i64 %r175, 8
  %r180 = inttoptr i64 %r179 to ptr
  store double 2.200000e+00, ptr %r180, align 8
  %r181 = add i64 %r175, 16
  %r182 = inttoptr i64 %r181 to ptr
  store double 3.300000e+00, ptr %r182, align 8
  %r183 = add i64 %r172, 24
  %r184 = inttoptr i64 %r183 to ptr
  store i64 %r175, ptr %r184, align 8
  %r185 = call ptr @malloc(i64 32)
  %r186 = ptrtoint ptr %r185 to i64
  %r187 = add i64 %r186, 8
  %r188 = sub i64 %r187, -8
  %r189 = inttoptr i64 %r188 to ptr
  store i64 3, ptr %r189, align 8
  %r190 = inttoptr i64 %r187 to ptr
  store i64 1, ptr %r190, align 8
  %r191 = add i64 %r187, 8
  %r192 = inttoptr i64 %r191 to ptr
  store i64 2, ptr %r192, align 8
  %r193 = add i64 %r187, 16
  %r194 = inttoptr i64 %r193 to ptr
  store i64 3, ptr %r194, align 8
  %r195 = add i64 %r172, 16
  %r196 = inttoptr i64 %r195 to ptr
  store i64 %r187, ptr %r196, align 8
  %r197 = add i64 %r172, 8
  %r198 = inttoptr i64 %r197 to ptr
  store double 1.100000e+00, ptr %r198, align 8
  %r199 = inttoptr i64 %r172 to ptr
  store i64 1, ptr %r199, align 8
  %r200 = add i64 %r172, 0
  ...
  call void @putch(i64 10)
  %r209 = call ptr @malloc(i64 48)
  %r210 = ptrtoint ptr %r209 to i64
  %r211 = inttoptr i64 %r210 to ptr
  store i64 5, ptr %r211, align 8
  %r212 = add i64 %r210, 8
  %r213 = add i64 %r212, 0
  %r214 = sub i64 %r213, 8
  %r215 = inttoptr i64 %r214 to ptr
  %r216 = load i64, ptr %r215, align 8
  call void @putint(i64 %r216)
  call void @putch(i64 10)
  %r217 = add i64 %r200, 8
  %r218 = inttoptr i64 %r217 to ptr
  %s219 = load double, ptr %r218, align 8
  ...
  %s225 = load double, ptr %r224, align 8

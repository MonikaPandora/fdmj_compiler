...
C11:
  %r139 = add i64 0, 0
  %r140 = call ptr @malloc(i64 64)
  %r141 = ptrtoint ptr %r140 to i64
  %r142 = add i64 %r141, 8
  %r143 = sub i64 %r142, 8
  %r144 = inttoptr i64 %r143 to ptr
  store i64 7, ptr %r144, align 8
  %r145 = inttoptr i64 %r142 to ptr
  store double 6.000000e+00, ptr %r145, align 8
  %r146 = add i64 %r142, 8
  %r147 = inttoptr i64 %r146 to ptr
  store double 3.000000e+00, ptr %r147, align 8
  ...
  store double 5.000000e+00, ptr %r151, align 8
  %r152 = add i64 %r142, 32
  %r153 = inttoptr i64 %r152 to ptr
  store double 9.000000e+00, ptr %r153, align 8
  %r154 = add i64 %r142, 40
  %r155 = inttoptr i64 %r154 to ptr
  store double 1.000000e+00, ptr %r155, align 8
  %r156 = add i64 %r142, 48
  %r157 = inttoptr i64 %r156 to ptr
  store double 2.000000e+00, ptr %r157, align 8
  %r158 = call ptr @malloc(i64 8)
  %r159 = ptrtoint ptr %r158 to i64
  %r160 = inttoptr i64 %r159 to ptr
  %r161 = ptrtoint ptr @"b1$bubbleSort" to i64
  store i64 %r161, ptr %r160, align 8
  %r162 = add i64 %r159, 0
  %r163 = inttoptr i64 %r162 to ptr
  %r164 = load i64, ptr %r163, align 8
...
L9:                                               ; preds = %L7
  ...
  %s178 = load double, ptr %r177, align 8
...
L3:                                               ; preds = %L2
  %r217 = inttoptr i64 %r99 to ptr
  %r218 = load i64, ptr %r217, align 8
...
L6:                                               ; preds = %L2
  ...
  %s230 = load double, ptr %r229, align 8
...
L4:                                               ; preds = %L6
  ...
  %s236 = load double, ptr %r235, align 8
  %r237 = mul i64 %r214, 8
  ...
  %s244 = load double, ptr %r243, align 8
  store double %s244, ptr %r239, align 8
  %r245 = add i64 %r214, 1
  %r246 = mul i64 %r245, 8
  %r247 = add i64 %r100, %r246
  %r248 = inttoptr i64 %r247 to ptr
  store double %s236, ptr %r248, align 8
  br label %L5
}

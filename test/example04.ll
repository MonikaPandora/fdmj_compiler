...
define i64 @main() {
C1:
  %r112 = call ptr @malloc(i64 24)
  %r113 = ptrtoint ptr %r112 to i64
  %r114 = add i64 %r113, 8
  %r115 = sub i64 %r114, 8
  %r116 = inttoptr i64 %r115 to ptr
  store i64 2, ptr %r116, align 8
  %r117 = inttoptr i64 %r114 to ptr
  store double 1.000000e+00, ptr %r117, align 8
  %r118 = add i64 %r114, 8
  %r119 = inttoptr i64 %r118 to ptr
  store double 2.000000e+00, ptr %r119, align 8
  %r120 = add i64 %r114, 0
  %r121 = inttoptr i64 %r120 to ptr
  %s122 = load double, ptr %r121, align 8
  %r123 = fptosi double %s122 to i64
  ret i64 %r123
}

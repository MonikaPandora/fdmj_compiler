...
C1:
  ...
  store i64 2, ptr %r134, align 8
  %r135 = inttoptr i64 %r132 to ptr
  store i64 1, ptr %r135, align 8
  %r136 = add i64 %r132, 8
  %r137 = inttoptr i64 %r136 to ptr
  store i64 2, ptr %r137, align 8
  %r138 = call ptr @malloc(i64 16)
  %r139 = ptrtoint ptr %r138 to i64
  %r140 = inttoptr i64 %r139 to ptr
  %r141 = ptrtoint ptr @"c1$m" to i64
  store i64 %r141, ptr %r140, align 8
  %r142 = add i64 %r139, 0
  %r143 = inttoptr i64 %r142 to ptr
  store i64 5, ptr %r143, align 8
  %r144 = inttoptr i64 %r142 to ptr
  %r145 = load i64, ptr %r144, align 8
  %r146 = inttoptr i64 %r145 to ptr
  %r147 = add i64 233, 0
  %r148 = call i64 %r146(i64 %r142, i64 %r142, i64 %r132, i64 %r147)
  call void @putint(i64 %r148)
  call void @putch(i64 10)
  %r149 = call ptr @malloc(i64 24)
  %r150 = ptrtoint ptr %r149 to i64
  %r151 = inttoptr i64 %r150 to ptr
  %r152 = ptrtoint ptr @"d1$m1_m2" to i64
  store i64 %r152, ptr %r151, align 8
  %r153 = inttoptr i64 %r150 to ptr
  %r154 = ptrtoint ptr @"d1_m1$m2" to i64
  store i64 %r154, ptr %r153, align 8
  %r155 = add i64 %r150, 0
  %r156 = inttoptr i64 %r155 to ptr
  %r157 = load i64, ptr %r156, align 8
  %r158 = inttoptr i64 %r157 to ptr
  %r159 = call i64 %r158(i64 %r155)
  call void @putint(i64 %r159)
  call void @putch(i64 10)
  ret i64 0
}

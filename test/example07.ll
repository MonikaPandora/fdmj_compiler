...
define i64 @main() {
C1:
  %r109 = call ptr @malloc(i64 16)
  %r110 = ptrtoint ptr %r109 to i64
  %r111 = inttoptr i64 %r110 to ptr
  store double 1.000000e+00, ptr %r111, align 8
  %r112 = add i64 %r110, 8
  %r113 = inttoptr i64 %r112 to ptr
  store double 1.000000e+00, ptr %r113, align 8
  %r114 = add i64 %r110, 8
  %r115 = inttoptr i64 %r114 to ptr
  %s116 = load double, ptr %r115, align 8
  %r117 = fptosi double %s116 to i64
  ret i64 %r117
}

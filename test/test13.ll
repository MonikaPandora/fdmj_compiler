...
L2:                                               ; preds = %L0
  ...
  %r228 = load i64, ptr %r227, align 8
  %r229 = mul i64 %r228, 8
  %r230 = add i64 %r195, %r229
  %r231 = inttoptr i64 %r230 to ptr
  %r232 = load i64, ptr %r231, align 8
  %r233 = add i64 %r232, 1
  store i64 %r233, ptr %r224, align 8
  %r234 = add i64 %r198, 1
  br label %L0
...
L8:                                               ; preds = %L3
  ...
  %r206 = load i64, ptr %r205, align 8
  %r207 = mul i64 %r201, 8
...
L6:                                               ; preds = %L8
  ...
  %r215 = load i64, ptr %r214, align 8
  br label %L7

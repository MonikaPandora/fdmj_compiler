...
define i64 @main() {
C13:
  %r130 = call ptr @malloc(i64 24)
  %r131 = ptrtoint ptr %r130 to i64
  %r132 = add i64 %r131, 8
  %r133 = inttoptr i64 %r132 to ptr
  store i64 0, ptr %r133, align 8
  %r134 = call ptr @malloc(i64 56)
  %r135 = ptrtoint ptr %r134 to i64
  %r136 = add i64 %r135, 8
  %r137 = sub i64 %r136, -8
  %r138 = inttoptr i64 %r137 to ptr
  store i64 6, ptr %r138, align 8
  %r139 = inttoptr i64 %r136 to ptr
  store i64 0, ptr %r139, align 8
  %r140 = add i64 %r136, 8
  %r141 = inttoptr i64 %r140 to ptr
  store i64 0, ptr %r141, align 8
  %r142 = add i64 %r136, 16
  %r143 = inttoptr i64 %r142 to ptr
  store i64 0, ptr %r143, align 8
  %r144 = add i64 %r136, 24
  %r145 = inttoptr i64 %r144 to ptr
  store i64 0, ptr %r145, align 8
  %r146 = add i64 %r136, 32
  %r147 = inttoptr i64 %r146 to ptr
  store i64 0, ptr %r147, align 8
  %r148 = add i64 %r136, 40
  %r149 = inttoptr i64 %r148 to ptr
  store i64 0, ptr %r149, align 8
  %r150 = inttoptr i64 %r131 to ptr
  store i64 %r136, ptr %r150, align 8
  %r151 = inttoptr i64 %r131 to ptr
  %r152 = ptrtoint ptr @"c$dfs" to i64
  store i64 %r152, ptr %r151, align 8
  %r153 = add i64 %r131, 0
  %r154 = inttoptr i64 %r153 to ptr
  %r155 = load i64, ptr %r154, align 8
...
L8:                                               ; preds = %L6
  ...
  %r211 = add i64 %r210, 1
  store i64 %r211, ptr %r207, align 8
  %r212 = add i64 1, 0
  br label %L9
...
L10:                                              ; preds = %L9
  ...
  %r220 = sub i64 %r219, 1
  store i64 %r220, ptr %r216, align 8
  ret i64 0
...
L1:                                               ; preds = %L3, %L4
  ...
  %r241 = load i64, ptr %r240, align 8
...
L3:                                               ; preds = %L1
  %r243 = inttoptr i64 %r99 to ptr
  %r244 = load i64, ptr %r243, align 8
  %r245 = mul i64 %r238, 8
  %r246 = add i64 %r244, %r245
  %r247 = inttoptr i64 %r246 to ptr
  %r248 = load i64, ptr %r247, align 8
...
L11:                                              ; preds = %L9
  %r221 = inttoptr i64 %r99 to ptr
  %r222 = load i64, ptr %r221, align 8
  %r223 = add i64 %r99, 8
  %r224 = inttoptr i64 %r223 to ptr
  %r225 = load i64, ptr %r224, align 8
  %r226 = sub i64 %r225, 1
  %r227 = mul i64 %r226, 8
  %r228 = add i64 %r222, %r227
  %r229 = inttoptr i64 %r228 to ptr
  store i64 %r213, ptr %r229, align 8
  %r230 = inttoptr i64 %r99 to ptr

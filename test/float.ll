...
C1:
  %r138 = add i64 0, 0
  %r139 = call ptr @malloc(i64 72)
  %r140 = ptrtoint ptr %r139 to i64
  %r141 = add i64 %r140, 8
  %r142 = sub i64 %r141, 8
  %r143 = inttoptr i64 %r142 to ptr
  store i64 8, ptr %r143, align 8
  %r144 = inttoptr i64 %r141 to ptr
  store i64 6, ptr %r144, align 8
  %r145 = add i64 %r141, 8
  %r146 = inttoptr i64 %r145 to ptr
  store i64 3, ptr %r146, align 8
  %r147 = add i64 %r141, 16
  %r148 = inttoptr i64 %r147 to ptr
  store i64 0, ptr %r148, align 8
  %r149 = add i64 %r141, 24
  %r150 = inttoptr i64 %r149 to ptr
  store i64 5, ptr %r150, align 8
  %r151 = add i64 %r141, 32
  %r152 = inttoptr i64 %r151 to ptr
  store i64 9, ptr %r152, align 8
  %r153 = add i64 %r141, 40
  %r154 = inttoptr i64 %r153 to ptr
  store i64 1, ptr %r154, align 8
  %r155 = add i64 %r141, 48
  %r156 = inttoptr i64 %r155 to ptr
  store i64 2, ptr %r156, align 8
  %r157 = add i64 %r141, 56
  %r158 = inttoptr i64 %r157 to ptr
  store i64 1, ptr %r158, align 8
  %s159 = fadd double 3.000000e-01, 0.000000e+00
  %r160 = call ptr @malloc(i64 56)
  %r161 = ptrtoint ptr %r160 to i64
  %r162 = add i64 %r161, 8
  %r163 = sub i64 %r162, 8
  %r164 = inttoptr i64 %r163 to ptr
  store i64 6, ptr %r164, align 8
  %r165 = inttoptr i64 %r162 to ptr
  store double 1.300000e+00, ptr %r165, align 8
  %r166 = add i64 %r162, 8
  %r167 = inttoptr i64 %r166 to ptr
  store double 3.000000e-01, ptr %r167, align 8
  %r168 = add i64 %r162, 16
  %r169 = inttoptr i64 %r168 to ptr
  store double 3.000000e-01, ptr %r169, align 8
  %r170 = add i64 %r162, 24
  %r171 = inttoptr i64 %r170 to ptr
  store double 0.000000e+00, ptr %r171, align 8
  %r172 = add i64 %r162, 32
  %r173 = inttoptr i64 %r172 to ptr
  store double 1.000000e-01, ptr %r173, align 8
  %r174 = add i64 %r162, 40
  %r175 = inttoptr i64 %r174 to ptr
  store double 6.660000e+02, ptr %r175, align 8
  ret i64 0
}

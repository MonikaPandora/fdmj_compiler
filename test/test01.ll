...
C1:
  %r147 = add i64 233, 0
  %r148 = call ptr @malloc(i64 16)
  %r149 = ptrtoint ptr %r148 to i64
  %r150 = add i64 %r149, 8
  %r151 = sub i64 %r150, 8
  %r152 = inttoptr i64 %r151 to ptr
  store i64 1, ptr %r152, align 8
  %r153 = inttoptr i64 %r150 to ptr
  store i64 1975, ptr %r153, align 8
  %r154 = call ptr @malloc(i64 32)
  %r155 = ptrtoint ptr %r154 to i64
  %r156 = add i64 %r155, 8
  %r157 = sub i64 %r156, 8
  %r158 = inttoptr i64 %r157 to ptr
  store i64 3, ptr %r158, align 8
  %r159 = inttoptr i64 %r156 to ptr
  store i64 1905, ptr %r159, align 8
  %r160 = add i64 %r156, 8
  %r161 = inttoptr i64 %r160 to ptr
  store i64 5, ptr %r161, align 8
  %r162 = add i64 %r156, 16
  %r163 = inttoptr i64 %r162 to ptr
  store i64 27, ptr %r163, align 8
  %s164 = fadd double 1.000000e+00, 0.000000e+00
  %r165 = call ptr @malloc(i64 16)
  %r166 = ptrtoint ptr %r165 to i64
  %r167 = add i64 %r166, 8
  %r168 = sub i64 %r167, 8
  %r169 = inttoptr i64 %r168 to ptr
  store i64 1, ptr %r169, align 8
  %r170 = inttoptr i64 %r167 to ptr
  store double 1.975000e+01, ptr %r170, align 8
  %r171 = call ptr @malloc(i64 32)
  %r172 = ptrtoint ptr %r171 to i64
  %r173 = add i64 %r172, 8
  %r174 = sub i64 %r173, 8
  %r175 = inttoptr i64 %r174 to ptr
  store i64 3, ptr %r175, align 8
  %r176 = inttoptr i64 %r173 to ptr
  store double 1.950000e+01, ptr %r176, align 8
  %r177 = add i64 %r173, 8
  %r178 = inttoptr i64 %r177 to ptr
  store double 5.500000e+00, ptr %r178, align 8
  %r179 = add i64 %r173, 16
  %r180 = inttoptr i64 %r179 to ptr
  store double 2.700000e+00, ptr %r180, align 8
  %r181 = call ptr @malloc(i64 32)
  %r182 = ptrtoint ptr %r181 to i64
  %r183 = add i64 %r182, 8
  %r184 = sub i64 %r183, 8
  %r185 = inttoptr i64 %r184 to ptr
  store i64 3, ptr %r185, align 8
  %r186 = inttoptr i64 %r183 to ptr
  store i64 2024, ptr %r186, align 8
  %r187 = add i64 %r183, 8
  %r188 = inttoptr i64 %r187 to ptr
  store i64 5, ptr %r188, align 8
  %r189 = add i64 %r183, 16
  %r190 = inttoptr i64 %r189 to ptr
  store i64 22, ptr %r190, align 8
  ret i64 0
}

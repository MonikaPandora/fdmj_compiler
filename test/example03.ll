...
define i64 @main() {
C4:
  %s105 = fadd double 1.000000e+00, 0.000000e+00
  br label %L0

L0:                                               ; preds = %L2, %C4
  %s106 = phi double [ %s111, %L2 ], [ %s105, %C4 ]
  %r107 = add i64 0, 0
  %s108 = sitofp i64 %r107 to double
  %r109 = fcmp one double %s106, %s108
  br i1 %r109, label %L2, label %L1

L1:                                               ; preds = %L0
  %r110 = fptosi double %s106 to i64
  ret i64 %r110

L2:                                               ; preds = %L0
  %s111 = fadd double 0.000000e+00, 0.000000e+00
  br label %L0
}

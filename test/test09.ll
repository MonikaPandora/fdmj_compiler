...
define i64 @main() {
C9:
  %r155 = call ptr @malloc(i64 96)
  %r156 = ptrtoint ptr %r155 to i64
  %r157 = add i64 %r156, 8
  %r158 = sub i64 %r157, 8
  %r159 = inttoptr i64 %r158 to ptr
  store i64 11, ptr %r159, align 8
  %r160 = inttoptr i64 %r157 to ptr
  store i64 1, ptr %r160, align 8
  %r161 = add i64 %r157, 8
  %r162 = inttoptr i64 %r161 to ptr
  store i64 9, ptr %r162, align 8
  %r163 = add i64 %r157, 16
  %r164 = inttoptr i64 %r163 to ptr
  store i64 3, ptr %r164, align 8
  %r165 = add i64 %r157, 24
  %r166 = inttoptr i64 %r165 to ptr
  store i64 0, ptr %r166, align 8
  %r167 = add i64 %r157, 32
  %r168 = inttoptr i64 %r167 to ptr
  store i64 7, ptr %r168, align 8
  %r169 = add i64 %r157, 40
  %r170 = inttoptr i64 %r169 to ptr
  store i64 1, ptr %r170, align 8
  %r171 = add i64 %r157, 48
  %r172 = inttoptr i64 %r171 to ptr
  store i64 3, ptr %r172, align 8
  %r173 = add i64 %r157, 56
  %r174 = inttoptr i64 %r173 to ptr
  store i64 0, ptr %r174, align 8
  %r175 = add i64 %r157, 64
  %r176 = inttoptr i64 %r175 to ptr
  store i64 2, ptr %r176, align 8
  %r177 = add i64 %r157, 72
  %r178 = inttoptr i64 %r177 to ptr
  store i64 9, ptr %r178, align 8
  %r179 = add i64 %r157, 80
  %r180 = inttoptr i64 %r179 to ptr
  store i64 6, ptr %r180, align 8
  %r181 = add i64 0, 0
  %r182 = add i64 11, 0
  br label %L0

L0:                                               ; preds = %L3, %C9
  %r183 = phi i64 [ %r189, %L3 ], [ %r181, %C9 ]
  %r184 = icmp slt i64 %r183, %r182
  br i1 %r184, label %L7, label %L1

L1:                                               ; preds = %L0
  %r185 = inttoptr i64 %r157 to ptr
  call void @putarray(i64 %r182, ptr %r185)
...
L2:                                               ; preds = %L5, %L7
  %r187 = phi i64 [ %r199, %L5 ], [ %r186, %L7 ]
  %r188 = icmp slt i64 %r187, %r182
  br i1 %r188, label %L6, label %L3
...
L6:                                               ; preds = %L2
  %r190 = mul i64 %r183, 8
  %r191 = add i64 %r157, %r190
  %r192 = inttoptr i64 %r191 to ptr
  %r193 = load i64, ptr %r192, align 8
  %r194 = mul i64 %r187, 8
  %r195 = add i64 %r157, %r194
  %r196 = inttoptr i64 %r195 to ptr
  %r197 = load i64, ptr %r196, align 8
  %r198 = icmp sgt i64 %r193, %r197
  br i1 %r198, label %L4, label %L5
...
L4:                                               ; preds = %L6
  %r200 = mul i64 %r183, 8
  %r201 = add i64 %r157, %r200
  %r202 = inttoptr i64 %r201 to ptr
  %r203 = load i64, ptr %r202, align 8
  %r204 = mul i64 %r183, 8
  %r205 = add i64 %r157, %r204
  %r206 = inttoptr i64 %r205 to ptr
  %r207 = mul i64 %r187, 8
  %r208 = add i64 %r157, %r207
  %r209 = inttoptr i64 %r208 to ptr
  %r210 = load i64, ptr %r209, align 8
  store i64 %r210, ptr %r206, align 8
  %r211 = mul i64 %r187, 8
  %r212 = add i64 %r157, %r211
  %r213 = inttoptr i64 %r212 to ptr
  store i64 %r203, ptr %r213, align 8
  br label %L5
}

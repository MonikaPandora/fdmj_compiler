; ModuleID = '/home/monika/compiler/fdmj_compiler/src/vendor/libsysy/libsysy64.c'
source_filename = "/home/monika/compiler/fdmj_compiler/src/vendor/libsysy/libsysy64.c"
...
define dso_local double @getfloat() #0 {
  ...
  %2 = call i32 (i8*, ...) @__isoc99_scanf(i8* noundef getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), double* noundef %1)
...
define dso_local i64 @getch() #0 {
  %1 = alloca i8, align 1
  %2 = call i32 (i8*, ...) @__isoc99_scanf(i8* noundef getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i8* noundef %1)
...
10:                                               ; preds = %6
  ...
  %14 = call i32 (i8*, ...) @__isoc99_scanf(i8* noundef getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i64* noundef %13)
  br label %15
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @getfarray(double* noundef %0) #0 {
...
10:                                               ; preds = %6
  ...
  %14 = call i32 (i8*, ...) @__isoc99_scanf(i8* noundef getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), double* noundef %13)
  br label %15
...
define dso_local void @putch(i64 noundef %0) #0 {
  ...
  %5 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i32 noundef %4)
  ret void
}
...
define dso_local void @putarray(i64 noundef %0, i64* noundef %1) #0 {
  ...
  %7 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str.3, i64 0, i64 0), i64 noundef %6)
...
12:                                               ; preds = %8
  ...
  %17 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str.4, i64 0, i64 0), i64 noundef %16)
  br label %18
...
21:                                               ; preds = %8
  %22 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.5, i64 0, i64 0))
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @putfarray(i64 noundef %0, double* noundef %1) #0 {
  %3 = alloca i64, align 8
...
12:                                               ; preds = %8
  ...
  %17 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([5 x i8], [5 x i8]* @.str.6, i64 0, i64 0), double noundef %16)
  br label %18
